...
def get_arguments():
    ...
    parser.add_argument("--caffemodel", type=str,default="./vgg16_20M.caffemodel",
    ...
    parser.add_argument("--pycaffe_path", type=str, default="/home/hit/luhui/caffe-ssd/python",
...
def main():
    ...
    try:
        sys.path.insert(0,args.pycaffe_path)
        import caffe
    except ImportError:
        raise
    # Load net definition.
